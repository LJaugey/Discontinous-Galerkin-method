...
ND::Array<double, System_dim> u0_custom(double x, string limit1, double y, string limit2)
{
    ND::Array<double, System_dim> result;

    return result;
}


ND::Array<double, System_dim> u0_sin(double x, string limit1, double y, string limit2)
{
    ND::Array<double, System_dim> result;
...
ND::Array<double, System_dim> u0_pos_sin(double x, string limit1, double y, string limit2)
{
    ND::Array<double, System_dim> result;
...
ND::Array<double, System_dim> u0_Euler_smooth(double x, string limit1, double y, string limit2)
{
    ND::Array<double, System_dim> result;
...
ND::Array<double, System_dim> u0_Sod(double x, string limit1, double y, string limit2)
{
    ND::Array<double, System_dim> result;
...
ND::Array<double, System_dim> Riemann_2D_1(double x, string limit1, double y, string limit2)
{
    ND::Array<double, System_dim> result;
...
ND::Array<double, System_dim> Riemann_2D_2(double x, string limit1, double y, string limit2)
{
    ND::Array<double, System_dim> result;
...
ND::Array<double, System_dim> Riemann_2D_3(double x, string limit1, double y, string limit2)
{
    ND::Array<double, System_dim> result;
...
ND::Array<double, System_dim> Riemann_2D_4(double x, string limit1, double y, string limit2)
{
    ND::Array<double, System_dim> result;
...
ND::Array<double, System_dim> Heat(double x, string limit1, double y, string limit2)
{
    ND::Array<double, System_dim> result;
...
ND::Array<double, System_dim> (*init_u0())(double, string, double, string)
{
    if(u0_Name == "Custom")
    {
        return u0_custom;
